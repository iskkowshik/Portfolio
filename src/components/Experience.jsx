...
const Experience = () => {
  ...
  At Turtil, I worked as an <strong>AI Engineer Intern</strong> during <strong>May to July 2025</strong>, where I developed an image-based microservice to verify the authenticity of college ID cards.
  Using a <strong>ResNet-based classifier</strong> and <strong>OCR-driven rule logic</strong>, the system detected image forgeries, template mismatches, and missing field anomalies — 
  ...
  This project strengthened my expertise in <strong>computer vision</strong>, <strong>model deployment</strong>, and <strong>backend integration</strong>.
</p>
